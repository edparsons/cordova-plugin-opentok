window.OT = {
  ...
  initPublisher: function(one, two, three, callback) {
...
TBPublisher = (function() {
  function TBPublisher(one, two, three, callback) {
    ...
    Cordova.exec(function(data) {if (callback) {callback(data);} TBSuccess(data);}, TBError, OTPlugin, "initPublisher", [name, position.top, position.left, width, height, zIndex, publishAudio, publishVideo, cameraName, ratios.widthRatio, ratios.heightRatio]);
